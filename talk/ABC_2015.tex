...
\section*{Scaling}
 ...
 \begin{frame}{Does niche breadth vary with latitude?}
    ...
    \begin{center}
      ...
      Want to show a dummy negative Gen vs. Lat due to S
...
\section*{Freshwaters}
  ...
  \begin{frame}{What's different in freshwaters?}
    \begin{block}{They're highly seasonal}
      ...
      \begin{columns}
        ...
        \includegraphics[width=.8\columnwidth]{Figures/spring_stream.eps}

        \vspace{.5cm}

        \includegraphics[width=.8\columnwidth]{Figures/fall_stream.eps}
  ...
  % Heading off the "but so are terrestrial" issue
  \begin{frame}{What's different in freshwaters?}
    \begin{block}{They're aquatic}

      [picture of a fish vs. a land beast]
      [gape limitation]
...
\section*{Conclusion and Acknowledgements}
    ...
    \begin{columns}
     \column{2.5in}
      ...
      \vspace{.25cm}
       ...
       \includegraphics[width=0.6\columnwidth]{marsden-logo-cmyk-tif.eps}

      \vspace{.25cm}

      \includegraphics[width=0.7\columnwidth]{Dal_logo.eps}
     ...
     \column{2.5in}
      ...
      \vspace{.25cm}
       ...
       \includegraphics[width=0.7\columnwidth]{NSERC_C.eps}

       \vspace{.25cm}

       \includegraphics[width=0.4\columnwidth]{logo-canterbury-color.eps} 
  ...
  \begin{frame}{Latitude affects scaling - sometimes}

  [Show the 5-panel plot, the equation.]
