...
\subsection*{Appendix S1: Details of Food Web Sources and Selection}
  ...
  species only. In addition, we included 12 of the 96 webs from~\citet{Brose2005}, which were originally
  collected to test the relationship between consumer and
  resources body sizes. The remaining webs the~\citet{Brose2005}
  dataset were also included in the~\citet{GlobalWeb} 
  dataset. This gave us a database of 259 webs. As we
  wished to use the logarithmic form of power-law
  relationships, we then eliminated any food web which
  did not have at least one each of basal resources,
  intermediate consumers, and top predators (to obtain 
  non-zero proportions of each category). Our final sample
  size was thereby reduced to 163 food webs.
