  ...
  \begin{landscape}
    ...
    {\footnotesize
      \begin{tabular}{p{2.8cm}p{1.3cm}p{5.5cm}p{2.2cm}p{2.5cm}lp{3.5cm}}
        ...
        17    & 3 & \cite{Hiatt1960}  & marine & 4,30 - 15 N & No    & Generalized scheme \\
        ...
        29    & 3 & \cite{Dunbar1953}  & marine &       & No    & Generalized scheme \\
        30    & 3 & \cite{Mackintosh1964}  & marine &       & No    & Generalized scheme \\
    ...
    {\footnotesize
      \begin{tabular}{p{2.8cm}p{1.3cm}p{5.5cm}p{2.2cm}p{2.5cm}lp{3.5cm}}
        ...
        40    & 3 & \cite{Harrison1962}  & terrestrial &       & No    & Generalized scheme \\
        ...
        50    & 3 & \cite{Nybakken1982}    & marine &       & No    & Generalized scheme \\
    ...
    {\footnotesize
      \begin{tabular}{p{2.8cm}p{1.3cm}p{5.5cm}p{2.2cm}p{2.5cm}lp{3.5cm}}
        ...
        92    & 3 & \cite{Swan1961}  & terrestrial &       & No    & Generalized scheme \\
        ...
        103   & 3 & \cite{Petipa1979}  & marine &       & No    & Generalized scheme \\
    ...
    {\footnotesize
      \begin{tabular}{p{2.8cm}p{1.3cm}p{5.5cm}p{2.2cm}p{2.5cm}lp{3.5cm}}
        ...
        125   & 3 & \cite{Landry1977}  & marine &       & No    & Generalized scheme \\
    ...
    {\footnotesize
      \begin{tabular}{p{2.8cm}p{1.3cm}p{5.5cm}p{2.2cm}p{2.5cm}lp{3.5cm}}
        ...
        210   & 3 & \cite{Percival1929}     & stream &       & No    & Generalized scheme \\
    ...
    {\footnotesize
      \begin{tabular}{p{2.8cm}p{1.3cm}p{5.5cm}p{2.2cm}p{2.5cm}lp{3.5cm}}
        ...
        358   & 3 & \cite{Schroter2003}  & terrestrial &       & No    & Generalized scheme \\
...
\subsection*{Appendix S2: Forms of scaling relationships with species richness}
  ...
  \subsubsection*{Methods}
    ...
    relationships for the standard devaitions of each property in~\cite{Riede2010}), we expect that they will follow
