...
\section*{Introduction} 
  ...
  degree of specialisation (i.e., the breadth of the Eltonian niche; ~\citealp{Elton1927,Leibold2010}) of species within food webs.
...
\section*{Methods}
  ...
  \subsection*{Data Set} 
    ...
    previous aggregations of food webs (i.e.,~\citet{GlobalWeb,Riede2011,Dunne2013}).
...
\begin{figure}[h]
\centerline{\includegraphics*[width=.85\textwidth]{Figures/Other/conceptual_figure.eps}}
...
(i.e., more feeding links). If hypothesis 2 is true, then the exponent of this
distribution should not vary significantly over latitude.}
\label{concept}
\end{figure}


\begin{figure}[h]
\centerline{\includegraphics*[width=.85\textwidth]{Figures/by_TL/scaling_with_S/proportions/S_fitlines_nonts.eps}}
...
\begin{figure}[h]
\centerline{\includegraphics*[height=.65\textheight]{Figures/by_TL/marginal/S_marginal_latitude_proportions.eps}}
