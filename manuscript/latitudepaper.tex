...
Link density, generality, and vulnerability each increased with increasing species richness ($\beta_0$=0.745, $p$\textless0.001; $\beta_0$=0.675, $p$\textless0.001; and $\beta_0$=0.745, $p$\textless0.001). 
For estuarine, marine, and terrestrial food webs this increase did not vary with latitude ($\beta_{Latitude}$=-0.001, $p$=0.334; $\beta_{Latitude}$=-0.001, $p$=0.354; and $\beta_{Latitude}$=-0.001, $p$=0.334)
