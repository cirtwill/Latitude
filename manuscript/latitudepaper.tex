...
\subsection*{Effect of Latitude on Scaling}
  ...
  latitude and food-web properties, except that $S$ was retained in all reduced models. 
...
\subsection*{Scaling Relationships with $S$ and Latitude}
  ...
  (link density, generality, vulnerability, and proportions of basal resources, intermediate consumers, and top predators), equation~(\ref{Loglog}) had a
  ...
  significant relationships with latitude in stream food webs but 
  no other ecosystem type 
  ($\beta_{Latitude}$=0.022, $p$=0.592 and $\beta_{Latitude:Stream}$=-0.356, $p$=0.007 for link density; 
  $\beta_{Latitude}$=0.011, $p$=0.589 and $\beta_{Latitude:Stream}$=-0.179, $p$=0.007 for vulnerability). However, after
  the removal of three outliers these relationships were no longer
  significant. The best-fit
  version of equation~(\ref{Latfull}) for generality did not include any effect of
...
$p$\textless0.001; and $\beta_0$=0.745, $p$\textless0.001).  For estuarine,
marine, and terrestrial food webs this increase did not vary with latitude
($\beta_{Latitude}$=-0.001, $p$=0.334; $\beta_{Latitude}$=-0.001, $p$=0.354;
and $\beta_{Latitude}$=-0.001, $p$=0.334). In lake food webs, link density,
generality, and vulnerability all increased more quickly towards the poles
($\beta_{Latitude:Lake}$=0.004, $p$=; $\beta_{Latitude:Lake}$=0.005,
$p$=0.002; and $\beta_{Latitude:Lake}$=0.005, $p$=0.008, respectively) In
stream food webs, only the strength of scaling of generality increased with
latitude ($\beta_{Latitude}$=0.007, $p$=0.002).
...
estuarine, lake, and stream food webs these decreases were steeper towards the
...
while in terrestrial food webs scaling was stronger towards the 
...
not include any effect of latitude on scaling in any ecosystem type. Scaling
of generality was stronger towards the equator in estuarine, lake, marine, and
...
$p$=0.053). In lake and stream food webs, generality increased more weakly
...
vulnerability was steeper towards the poles, although this trend was
...
\begin{figure}[!h]
\label{S}
\includegraphics[width=.9\textwidth]{Figures/by_TL/scaling_with_S/proportions/S_latlines_nonts.eps}
\caption{}
\end{figure}
