...
temperature \citep{}, primary productivity \citep{}, and seasonality \citep{}. Indeed, each of these latitudinal 
environmental gradients has been put forward as a driver for the latitudinal gradient in species richness, one of
the most general and robust patterns in ecology \citep{Schemske2009a,,}.
...
\subsection*{Data Set}
We compiled a list of 347 empirical food webs from an online database (GlobalWeb webs \citep{GlobalWeb}), supplemented 
...
competitive interactions (8+34+2=44), described inferred interactions in an extinct community (2), were ``generalized 
...
interactions between them \citep{Dunne2013}. For each of the 263 webs included in the final database, we recorded the
...
terrestrial, or marine food web respectively (e.g., $\Sigma_{i}$=1 for 
