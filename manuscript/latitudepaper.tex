...
\section*{Introduction} 
  ...
  By modulating interactions between species, latitudinal gradients may also shape food-web structure~\citep{}.
  Indeed, these latitudinal environmental gradients have been put forward as potential drivers for the 
  latitudinal gradient in species richness, one of the most general and robust patterns in ecology~\citep{Schemske2009a,Stegen2009,Macpherson2002,Kaufman1995}.
...
\section*{Discussion}
  ...
  strongly with other studie~\citep{}. As numbers of species and links included in a food web
  ...
  may affect speciation rates and therefore the diversity in a region~\citep()).
  ...
  specialists, as has been observed in mutualist networks~\citep{}. Inhabitants of high-latitude
  freshwater communities may also be more generalist due to prey switching if they rely on a series
  of ephemeral prey such as maturing insect larvae~\citep{}.
