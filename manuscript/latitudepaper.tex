...
set of 196 empirical food webs.  We also investigated scaling relationships
...
\section*{Introduction} 
  ...
  we test for the effects of latitude on specialisation implied by the
...
\section*{Methods}
  ...
  \subsection*{Data Set} 
    ...
    of this range. We grouped food web by ecosystem type (stream, N=71; lake, N=47; marine, 
...
\section*{Discussion}
  ...
  mean that, relative to larger, more abiotically stable estuarine and marine
  communities, freshwater food webs may experience high turnover in both
  community composition and productivity. Notable exceptions from the above
  ...
  Zealand communities are typified by ecological
  ...
  high latitudes, and can also obtain significant allochthonous
  inputs~\cite{Nakano2001}, terrestrial consumers tend to be more
  ...
  key to this this explanation of the differences between freshwater and
  ...
  oceans and estuaries certainly do vary in terms of water temperature and
  nutrients over the course of a year~\cite{Baird1989}, because they are not isolated
  in the midst of a terrestrial matrix these changes are likely to be slower
  and milder than in freshwaters. Net primary productivity in particular is
...
(i.e., more feeding links). If hypothesis 2 is true, then the exponent of this distribution should not vary significantly over latitude.}
\label{concept}
\end{figure}
