...
\section*{Results}
  ...
  that there was little overall scaling relationship. In contrast, the scaling
  ...
  $\beta_{Latitude}$=-0.001, $p$=0.472 for vulnerability) except in stream and terrestrial food
  webs, where scaling was more strongly negative in the tropics and near zero
  near the poles ($\beta_{Latitude:Stream}$=0.012, $p$=0.001 and $\beta_{Latitude:Terrestrial}$=0.009, $p$=0.015 for link density;
  $\beta_{Latitude:Stream}$=0.012, $p$=0.001 and
  $\beta_{Latitude:Terrestrial}$=0.009, $p$=0.015
  for vulnerability;
