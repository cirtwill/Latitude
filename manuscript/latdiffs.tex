...
%DIF ADD latitudepaper.tex             Tue Aug 25 09:25:15 2015
\usepackage{amsmath}
\usepackage{gensymb}
\usepackage{url}
...
%DIFDELCMD <   %%%
\section*{\DIFdel{Scaling by Trophic Levels}}
%DIFAUXCMD
%DIFDELCMD < 

%DIFDELCMD <     %%%
\DIFdel{We were also interested in the ways that scaling relationships with species richness might
    ...
    richness.
    }\DIFdelend \DIFaddbegin \DIFadd{, as this model is the least likely to suffer from over-fitting.
...
\section*{Results}
  ...
  Link density, generality, and vulnerability \DIFdelbegin \DIFdel{each }\DIFdelend \DIFaddbegin \DIFadd{were strongly and positively
  ...
  }\DIFaddend increased with increasing
...
\DIFdel{As with species richness, link density, generality, and vulnerability
  ...
  The }\DIFdelend \DIFaddbegin \DIFadd{the interaction term $\beta_{Latitude:Stream}$ was not retained in the }\DIFaddend best-fit models\DIFdelbegin \DIFdel{for link density and vulnerability did not include
