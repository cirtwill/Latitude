...
% ---------------------------------------
  ...
  of our overall results. [[done]] We have also added a brief note in the main text to direct other
  readers with similar concerns to the supporting information. [[not done]]
...
% ---------------------------------------
  ...
  Polite pre-amble.
  ``This is an interesting study on a timely and important topic. The core analysis of the paper (scaling relationships of food web metrics with species richness) are convincingly presented and comprehensively discussed.''1
