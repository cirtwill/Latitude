...
% ---------------------------------------
  ...
  $\delta$AIC\textess2 are roughly equally well-supported. This is why our
  procedure (as stated in lines XX-XX) was to first consider the set of models
  where $\delta$AIC\textess2 and select the model with the fewest degrees of
  freedom. We chose the smallest model where $\delta$AIC\textess2 in order to
  ...
  had $\delta$AIC\textess2.  In fact, this scenario did not occur for the
