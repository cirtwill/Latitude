S_CIs <- function(model){
      ...
      # if(model=="LS_min" | model=="Vul_min"){
        ...
        results <- cbind(lat,marginal,upper,lower,terr_m,terr_upper,terr_lower,lake_m,lake_upper,lake_lower,marine_m,marine_upper,marine_lower)
        colnames(results)=c("Latitude","Marginal","Upper","Lower","Terrestrial","Terr_upper","Terr_lower","Lakeweb","Lakeweb_upper","Lakeweb_lower","Marine","Marine_upper","Marine_lower")
      # }
      ...
      results <- cbind(lat,marginal,upper,lower,terr_m,terr_upper,terr_lower,
        lake_m,lake_upper,lake_lower,stream_m,stream_upper,stream_lower)
      colnames(results)=c("Latitude","Marginal","Upper","Lower","Terrestrial","Terr_upper","Terr_lower",
